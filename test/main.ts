console.log('@@@@@@@@@@@@@')
import { initContext, setBuffersAndAttributes, drawBufferInfo, setProgram } from '../src/Twebgl'
import { createGeometryInfoFromArray } from '../src/GeometryInfo'
import { createBassProgramInfo, createProgramInfo } from '../src/ProgramInfo'
import { createTextureFromHtml } from '../src/Texture'
  ...
  static run() {
    ...
    imag.onload = () => {
      ...
      program = createProgramInfo(gl, {
        program: { vs: def_vs, fs: def_fs, name: 'ssxxss' },
        uniforms: uniforms,
        states: state
      })
    }
