...
export class GeometryInfo implements IGeometryInfo {
    ...
    atts: {
        [attName: string]: IVertexAttrib;
    };
    indices?: IVertexIndex;
    count: number;
    offset: number;
}
export function createGeometryInfoFromArray(gl: WebGLRenderingContext, atts: {
    [keyName: string]: TArrayInfo;
}, indices?: TArrayInfo, primitiveType?: number): IGeometryInfo;
...
export function getArrayTypeForGLtype(glType: number): Float32ArrayConstructor | Int8ArrayConstructor | Uint8ArrayConstructor | Uint8ClampedArrayConstructor | Int16ArrayConstructor | Uint16ArrayConstructor | Int32ArrayConstructor | Uint32ArrayConstructor;
export function getbytesForGLtype(glType: number): 1 | 2 | 4;
...
export function getAttributesInfo(gl: WebGLRenderingContext, program: WebGLProgram): {
    [attName: string]: IAttributeInfo;
};
export function getUniformsInfo(gl: WebGLRenderingContext, program: WebGLProgram): {
    [name: string]: IUniformInfo;
};
export function createShader(gl: WebGLRenderingContext, type: ShaderTypeEnum, source: string, name?: String): {
    shaderType: ShaderTypeEnum;
    shaderName: String;
    shader: WebGLShader;
};
export function getUniformSetter(gl: WebGLRenderingContext, uniformType: number, beArray: boolean, location: WebGLUniformLocation, bindpoint: number): (value: any) => void;
export function getAttributeSetter(gl: WebGLRenderingContext, location: number): (value: IVertexAttrib) => void;

export function setProgramState(gl: WebGLRenderingContext, state: IProgramState): void;

export function createTextureFromTypedArray(gl: WebGLRenderingContext, data: ArrayBufferView, texOP: ITexViewDataInfo): void;
...
export function deduceTextureTypedArrayOption(gl: WebGLRenderingContext, data: ArrayBufferView, texOP: ITexViewDataInfo): void;
export function deduceTextureHtmlOption(gl: WebGLRenderingContext, data: HTMLImageElement | HTMLCanvasElement, texOP: ITexHtmlDataInfo): void;
...
global {
    ...
    interface WebGLRenderingContext {
        ...
        beWebgl2: any;
        addExtension(extName: string): any;
        createVertexArray(): any;
        bindVertexArray(vao?: WebGLVertexArrayObject | null): void;
        deleteVertexArray(vao: WebGLVertexArrayObject): void;
        vertexAttribDivisor(index: number, divisor: number): void;
        drawElementsInstanced(mode: number, count: number, type: number, offset: number, instanceCount: number): any;
        drawArraysInstanced(mode: number, first: number, count: number, instanceCount: number): any;
    }
}
export function initContext(canvas: HTMLCanvasElement, options?: IcontextOptions): WebGLRenderingContext;
export function setBuffersAndAttributes(gl: WebGLRenderingContext, geometry: IGeometryInfo, program: IBassProgramInfo): void;
export function setProgram(gl: WebGLRenderingContext, program: IProgramInfo): void;
export function setProgramUniforms(info: IBassProgramInfo, uniforms: {
    [name: string]: any;
}): void;
